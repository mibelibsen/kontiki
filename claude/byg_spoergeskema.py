...
def skriv_side(unger):
    if FORSLAG:
        ...
        forslag_blok = ('<div class="blok"><h3>Sådan skriver du et spørgsmål</h3>'
                        ...
                        'Find den næste tomme linje og udfyld den fra venstre mod højre:</p>'
                        '<ol>'
                        '<li><b>Navn</b> — dit fornavn.</li>'
                        '<li><b>Deine Frage auf Deutsch</b> — spørgsmålet, som en tysker skal læse det.</li>'
                        '<li><b>Antworttyp</b> — vælg i rullemenuen: <i>Ja/Nein</i>, <i>Auswahl</i> (flere svar at vælge imellem), '
                        '<i>Skala 1–5</i>, <i>Zahl</i> (et tal, fx timer eller euro) eller <i>Freier Text</i>.</li>'
                        '<li><b>Antwort 1, Antwort 2, …</b> — kun hvis du valgte <i>Auswahl</i>. Skriv én svarmulighed i hver kolonne, '
                        'mindst to og højst fem. Resten lader du stå tomme. Ved de andre svartyper skriver du ikke noget her.</li>'
                        '</ol>'
                        '<table class="t"><tr><th>Navn</th><th>Deine Frage auf Deutsch</th><th>Antworttyp</th><th>Antwort 1</th><th>Antwort 2</th><th>Antwort 3</th></tr>'
                        '<tr><td>Anna</td><td>Wie viele Stunden am Tag bist du am Handy?</td><td>Auswahl</td><td>Unter 2</td><td>2–4</td><td>Mehr als 4</td></tr>'
                        '<tr><td>Jonas</td><td>Hast du einen Nebenjob?</td><td>Ja/Nein</td><td></td><td></td><td></td></tr>'
                        '<tr><td>Luna</td><td>Wie zufrieden bist du mit deiner Schule?</td><td>Skala 1–5</td><td></td><td></td><td></td></tr>'
                        '</table>'
                        '<p>Husk: kun de fire første svartyper kan tælles og tegnes som diagram. Ret ikke i andres linjer. '
                        'Linjen <i>Eksempel</i> øverst tæller ikke med.</p>'
                        f'{forslag_knap}</div>')
    else:
        forslag_knap = ''
...
<p>Din kode fører til adressen <b>{html.escape(SITE.replace('https://', ''))}/u/dit-navn</b>. Den sender videre til det fælles spørgeskema med dit navn gemt i linket, så hvert svar tæller for dig. Den, der svarer, ser bare spørgeskemaet.</p>
